            ...
            @foreach ($edificios as $edificio)
                <tr>
                    ...
                    <td class="align-middle"><span
                            class="badge @if ($edificio->activo == 1) badge-success @else badge-warning text-dark @endif rounded-pill">
                    ...
                    <td class="align-middle">
                        <div>
                            {{-- Editar --}}
                            <a href="/edificios/{{ $edificio->id }}/editar"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            {{-- Eliminar --}}
                            <form action="/edificios/{{ $edificio->id }}" method="POST" style="display: inline-block">
                                @method('DELETE')
                                @csrf
