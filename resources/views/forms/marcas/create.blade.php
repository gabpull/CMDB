...
@section('content')
    <div class="container-md p-5 my-5 border">
        <form action="/marcas/creado" enctype="multipart/form-data" method="POST">
            <div class="mb-3">
                <h3 class="form-label">Creación de Marcas</h3>
                <br>
            </div>
            @csrf
            <div class="mb-3">
                <label class="form-label">Marca</label>
                <input type="text" name="desc_marca" class="form-control form-control-sm" placeholder="Nombre Marca">
                @error('desc_marca')
                    <br>
