            ...
            @foreach ($marcas as $marca)
                <tr>
                    ...
                    <td class="align-middle">
                        <div>
                            <a href="/marcas/{{ $marca->id }}/editar"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <form action="/marcas/{{ $marca->id }}" method="POST" style="display: inline-block">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Está seguro de eliminar la marca')">
