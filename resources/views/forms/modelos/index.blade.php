...
@section('content')
    ...
    <div>
        <a href="/modelos/crear" class="btn btn-primary ">
            {{ __('Crear Modelos') }}
        </a>
    </div>
    <hr>
            ...
            @foreach ($modelos as $modelo)
                <tr>
                    ...
                    <td class="align-middle">
                        <div>
                            <a href="/modelos/{{ $modelo->id }}/editar"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <form action="/modelos/{{ $modelo->id }}" method="POST" style="display: inline-block">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Está seguro de eliminar el modelo')">
